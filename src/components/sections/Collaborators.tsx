...
const PLATFORMS = [
  ...
  },
  {
    name: "Solana",
    short: "SOL",
    category: "Blockchain · L1",
    description: "High-performance Layer 1 blockchain — used in KineTex for on-chain escrow contracts and trustless freelance payments.",
    color: "#9945FF",
  ...
  },
  {
    name: "Anchor",
    short: "ANCR",
    category: "Smart Contracts · Solana",
    description: "Framework for building secure Solana programs in Rust — used in KineTex to implement the on-chain escrow protocol.",
    color: "#7DE2D1",
  ...
  },
  {
    ...
    description: "Memory-safe systems programming language — used with Anchor to write Solana smart contracts in KineTex.",
    color: "#FF8A3C",
  ...
  },
  {
    name: "Wagmi",
    short: "WGM",
    category: "Web3 · React Hooks",
    description: "React hooks library for Ethereum — used in the NFT Marketplace for wallet connection and on-chain interactions.",
    color: "#4A9EFF",
    url: "https://wagmi.sh",
  },
  {
    name: "Chainlink",
    short: "LINK",
    category: "Oracle · Web3",
    description: "Decentralized oracle network — used in the DeFi Stablecoin protocol for accurate on-chain price feeds.",
    color: "#335DD2",
  ...
  },
  {
    ...
    description: "JavaScript library for interacting with Ethereum and Solana nodes — used across DeFi and NFT Marketplace projects.",
    color: "#F16822",
